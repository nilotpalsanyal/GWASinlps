GWASinlps = function( y, x, family=c("normal","binomial"), cor_xy=NULL, mmle_xy=NULL, prior=c("mom", "imom", "zellner", "horeshoe"), tau, priorDelta = modelbbprior(1,1), k0, m, rxx, nskip = 3, niter = 2000, verbose = FALSE, seed = NULL, tau.hs.method = "halfCauchy", sigma.hs.method = "Jeffreys" )
{
	if(family == "normal")
	{
...
nlpsLM = function( y, x, cor_xy, prior = c("mom", "imom", "zellner", "horeshoe"), tau, priorDelta = modelbbprior(1,1), k0, rxx, niter = 2000, verbose = F, tau.hs.method = "halfCauchy", sigma.hs.method = "Jeffreys" )
{ 	
